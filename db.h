...
QueryResult select(const std::string& tableName, const std::vector<std::string>& columns, const std::string& condition, const std::string& orderBy = "", const std::string& orderDir = "ASC");
